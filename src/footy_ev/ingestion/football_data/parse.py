...
class FootballDataRow(BaseModel):
    ...
    # --- 1X2 closing odds (migration 002) ---
    b365ch: float | None = Field(default=None, alias="B365CH")
    b365cd: float | None = Field(default=None, alias="B365CD")
    b365ca: float | None = Field(default=None, alias="B365CA")
    bwch: float | None = Field(default=None, alias="BWCH")
    bwcd: float | None = Field(default=None, alias="BWCD")
    bwca: float | None = Field(default=None, alias="BWCA")
    whch: float | None = Field(default=None, alias="WHCH")
    whcd: float | None = Field(default=None, alias="WHCD")
    whca: float | None = Field(default=None, alias="WHCA")
    psch: float | None = Field(default=None, alias="PSCH")
    pscd: float | None = Field(default=None, alias="PSCD")
    psca: float | None = Field(default=None, alias="PSCA")
    iwch: float | None = Field(default=None, alias="IWCH")
    iwcd: float | None = Field(default=None, alias="IWCD")
    iwca: float | None = Field(default=None, alias="IWCA")
    vcch: float | None = Field(default=None, alias="VCCH")
    vccd: float | None = Field(default=None, alias="VCCD")
    vcca: float | None = Field(default=None, alias="VCCA")
    maxch: float | None = Field(default=None, alias="MaxCH")
    maxcd: float | None = Field(default=None, alias="MaxCD")
    maxca: float | None = Field(default=None, alias="MaxCA")
    avgch: float | None = Field(default=None, alias="AvgCH")
    avgcd: float | None = Field(default=None, alias="AvgCD")
    avgca: float | None = Field(default=None, alias="AvgCA")
    bfech: float | None = Field(default=None, alias="BFECH")
    bfecd: float | None = Field(default=None, alias="BFECD")
    bfeca: float | None = Field(default=None, alias="BFECA")

    # --- Over/Under 2.5 closing (migration 002) ---
    b365c_over_25: float | None = Field(default=None, alias="B365C>2.5")
    b365c_under_25: float | None = Field(default=None, alias="B365C<2.5")
    maxc_over_25: float | None = Field(default=None, alias="MaxC>2.5")
    maxc_under_25: float | None = Field(default=None, alias="MaxC<2.5")
    avgc_over_25: float | None = Field(default=None, alias="AvgC>2.5")
    avgc_under_25: float | None = Field(default=None, alias="AvgC<2.5")
    pc_over_25: float | None = Field(default=None, alias="PC>2.5")
    pc_under_25: float | None = Field(default=None, alias="PC<2.5")
    bfec_over_25: float | None = Field(default=None, alias="BFEC>2.5")
    bfec_under_25: float | None = Field(default=None, alias="BFEC<2.5")

    # --- Asian handicap closing + pre-match aggregates (migration 002) ---
    ahc_line: float | None = Field(default=None, alias="AHCh")
    b365c_ah_home: float | None = Field(default=None, alias="B365CAHH")
    b365c_ah_away: float | None = Field(default=None, alias="B365CAHA")
    maxc_ah_home: float | None = Field(default=None, alias="MaxCAHH")
    maxc_ah_away: float | None = Field(default=None, alias="MaxCAHA")
    avgc_ah_home: float | None = Field(default=None, alias="AvgCAHH")
    avgc_ah_away: float | None = Field(default=None, alias="AvgCAHA")
    pc_ah_home: float | None = Field(default=None, alias="PCAHH")
    pc_ah_away: float | None = Field(default=None, alias="PCAHA")
    bfec_ah_home: float | None = Field(default=None, alias="BFECAHH")
    bfec_ah_away: float | None = Field(default=None, alias="BFECAHA")
    max_ah_home: float | None = Field(default=None, alias="MaxAHH")
    max_ah_away: float | None = Field(default=None, alias="MaxAHA")
    avg_ah_home: float | None = Field(default=None, alias="AvgAHH")
    avg_ah_away: float | None = Field(default=None, alias="AvgAHA")
